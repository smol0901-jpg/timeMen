...
function botCommand(
  ...
  if (["помощь", "help", "команды"].includes(cmd)) {
    return `📋 СПИСОК КОМАНД БОТА (30+):

👥 СОТРУДНИКИ:
• создать сотрудника <имя> <цех>
• уволить <имя> <причина>
• изменить цех <имя> <цех>
• список сотрудников [<цех>]

📅 ГРАФИК:
• график <имя> <дата> <день|ночь|выходной>
• удалить смену <имя> <дата>
• проверить неделю | проверить месяц
• опубликовать график
...
💰 ФИНАНСЫ:
• расчёт <имя> <месяц>
• штраф <имя> <сумма> <причина>
• оценка <имя> <месяц> <баллы>
...
🔔 УВЕДОМЛЕНИЯ:
• напомнить <имя> <дата> <текст>
• написать <имя> <сообщение>
